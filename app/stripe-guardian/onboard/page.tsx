...
export const metadata = {
  ...
  description:
    'Connect your Stripe account to Guardian to monitor payouts and receive fraud alerts.',
};
  ...
  return (
    <Container className="py-20">
      <div className="max-w-3xl mx-auto text-center">
        <h1 className="text-2xl font-semibold">Set up your first account</h1>
        <p className="text-muted-foreground">
          You&apos;re almost there! Connect your Stripe account to get started.
        </p>

        <div className="flex justify-center mb-10">
          <Button asChild size="lg" className="bg-[#635BFF] hover:bg-[#5851EB]">
        ...
        <div className="text-sm text-slate-500 space-y-2">
          <p>
            We use Stripe Connect to securely link your account. Your credentials are never shared
            with us directly.
          </p>
          <p>You can disconnect Guardian from your Stripe account at any time.</p>
        </div>
      </div>
    </Container>
  );
