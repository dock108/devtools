...
const features = [
  {
    name: 'Auto-Discovery',
    description: 'Connects to Kubernetes, GitHub, GCP Cloud Scheduler, etc. to automatically find and list your cron jobs.',
    icon: ListChecks,
  },
  {
    name: 'Smart Alerts',
    description: 'Configure heartbeats or status checks. Get notified via Slack, PagerDuty, or webhooks on misfires or delays.',
    icon: BellRing,
  },
  {
    name: 'SLA Monitoring & History',
    description: 'Track job duration, success rates, and view historical trends to understand schedule performance over time.',
    icon: LineChart,
  },
]
...
const tiers = [
  {
    ...
    features: ['Up to 50 Cron Jobs', 'Kubernetes & GitHub Discovery', 'Basic Slack Alerts', '2 Weeks History'],
  },
  {
    name: 'Pro',
    id: 'tier-pro',
  ...
  return (
    <>
        ...
        <Container className="py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
               Auto-discovers Kubernetes CronJobs, GitHub Action schedules & cloud tasks, then alerts on misfires.
            </p>
            {/* Waitlist Form */}
            <div className="mt-8">
              <WaitlistForm 
      ...
      <div className="py-24 sm:py-32">
        <Container>
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Stop chasing down silent cron failures</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
      ...
      <div className="bg-white py-24 sm:py-32">
        <Container>
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">One dashboard to rule them all</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              {features.map((feature) => (
                ...
                >
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                    <feature.icon className="h-5 w-5 flex-none text-[var(--accent-crondeck)]" aria-hidden="true" />
                    {feature.name}
                  </dt>
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Predictable pricing for all teams</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              >
                <CardHeader>
                  ...
                  <div className="mt-4 flex items-baseline gap-x-2">
                    ...
                    <span className="text-sm font-semibold leading-6 tracking-wide text-gray-600">{tier.priceMonthly !== '$0' ? '/month' : ''}</span>
                  </div>
                </CardHeader>
                  ...
                  <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                    {tier.features.map((feature) => (
                      <li key={feature} className="flex gap-x-3">
                        <Check className="h-6 w-5 flex-none text-[var(--accent-crondeck)]" aria-hidden="true" />
                        {feature}
                      </li>
                    ))}
                  </ul>
