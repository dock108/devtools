...
- **/docs**: Documentation site for Stripe Guardian and other products.
...
Supabase Edge Functions (`send-welcome-email`, `weekly-digest`, `guardian-sync`) need to be deployed separately using the Supabase CLI and database triggers/cron schedules configured in the Supabase dashboard.
...
3. Access the documentation at [http://localhost:3000/docs](http://localhost:3000/docs)

### Editing Documentation

The documentation pages are in MDX format and located in the `/docs` directory. The sidebar navigation is configured in `/app/docs/config.tsx`.

To add a new documentation page:

1. Create a new `.mdx` file in the appropriate subfolder under `/docs`
2. Update the sidebar configuration in `/app/docs/config.tsx` if needed
3. Restart the development server to see your changes

### Documentation Structure

- `/docs/guardian/` - Stripe Guardian documentation
- `/docs/api/` - API reference documentation
- `/docs/general/` - General product documentation
